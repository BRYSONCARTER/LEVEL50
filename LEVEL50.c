...
//BIG PROBLEMS
//***fix and finalize damage formula




//+2atk, +2def, +def, +2speed, +2spatk, +2spdef, +spatk+spdef, +atk+def, +atk+speed, confuse, toxic, sleep, poison, paralyze, restore, rest,
...
//MEDIUM PROBLEMS
//***remove all debug messages (rn there are some in speed check)
//***clean up code
//***clean up printf, make game text flow well. CTRL+F \n   lol
//***send to lots of people for bug checks
